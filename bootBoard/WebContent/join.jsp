		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			...
			<ul class="navbar-nav ml-auto">
				<li class="nav-item dropdown">
					<a class="nav-link dropdown-toggle" href="#" id="navbarDrodown"
					...
					<div class="dropdown-drivider"></div>
						...
						<div class="form-group text-center">
							<div class="btn-group" data-toggle="buttons">
								<label class="btn btn-primary active">
									<input class="d-none" type="radio" name="userGender" autocomplete="off" value="남자" checked="checked"/>남자</label>
								<label class="btn btn-primary">
									<input class="d-none" type="radio" name="userGender" autocomplete="off" value="여자" />여자</label>
							</div>
						</div>
